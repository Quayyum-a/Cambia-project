    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {step === 'order-created' && order && (
        <div className="space-y-6">
              ...
              {connectedWallet ? (
                <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Wallet Connected: Using real blockchain addresses for escrow setup</span>
                  </div>
                </div>
              ) : (
                <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4">
                  <div className="flex items-center gap-2">
                    <span className="text-lg">🎯</span>
                    <span>Demo Mode: Connect wallet above for real addresses, or continue with simulated escrow</span>
                  </div>
                </div>
              )}
            </div>
          ...
          >
            {loading ? 'Setting Up Escrow...' : connectedWallet ? 'Setup Escrow with Wallet' : 'Continue with Demo Escrow'}
          </button>
        </div>
      )}
