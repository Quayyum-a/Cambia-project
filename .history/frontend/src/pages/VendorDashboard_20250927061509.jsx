  ...
  return (
    <div className="container">
      <div className="page-header">
        ...
        <p className="page-subtitle">Manage your products and orders</p>
      </div>
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="-mb-px flex space-x-8">
          <button
            ...
            className={activeTab === 'products' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Products
          </button>
          <button
            onClick={() => setActiveTab('add-product')}
            className={activeTab === 'add-product' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Add Product
          </button>
          <button
            onClick={() => setActiveTab('orders')}
            className={activeTab === 'orders' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Orders
          </button>
          <button
            onClick={() => setActiveTab('fulfillment')}
            className={activeTab === 'fulfillment' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Fulfillment
          </button>
        </nav>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                />
                <button
                  onClick={() => uploadProof(selectedOrder)}
                  disabled={!selectedOrder || !proofFile || loading}
