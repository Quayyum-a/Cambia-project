      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Cambia Marketplace</h1>
            <p className="text-gray-600">Discover authentic Nigerian products from trusted vendors</p>
          </div>
        </div>
      </div>
