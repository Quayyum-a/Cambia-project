...
export default function Checkout() {
  ...
  const createEscrow = async () => {
    ...
    try {
      ...
      // For demo purposes, skip wallet connection and use simulated escrow
      console.log('🎯 Creating Demo Escrow (simulated wallet connection)');

      const demoEscrowData = {
        senderAddress: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef', // Demo sender
        ...
        unlockKey: `demo-key-${order._id}-${Date.now()}`
      };

      const result = await api.post('/demo-escrow/create', demoEscrowData);
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {step === 'order-created' && order && (
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>Demo Mode: Using simulated blockchain escrow for demonstration</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            {loading ? 'Creating Demo Escrow...' : 'Setup Demo Escrow Payment'}
          </button>
        </div>
      )}
