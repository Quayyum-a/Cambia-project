  ...
  return (
    <div className="container">
      <div className="page-header">
        ...
        <p className="page-subtitle">Browse products and manage your orders</p>
      </div>
      ...
      <div className="border-b border-gray-200 mb-6">
        <nav className="-mb-px flex space-x-8">
          <button
            ...
            className={activeTab === 'browse' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Browse Products
          </button>
          <button
            onClick={() => setActiveTab('cart')}
            className={activeTab === 'cart' ? 'nav-link nav-link-active' : 'nav-link nav-link-inactive'}
          >
            Cart ({cart.length})
          </button>
          <button
                ...
                <div className="table-container">
                  <table className="table">
                    ...
                    <tbody className="table-body">
                      {orders.map(order => (
                        <tr key={order._id}>
                          <td className="table-body font-medium">#{order._id}</td>
                          <td className="table-body">
                            <span className="status-badge status-info capitalize">
                              {order.status}
                            </span>
                          </td>
                          <td className="table-body font-semibold">₦{order.totalPrice}</td>
