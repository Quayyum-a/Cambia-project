...
export default function Marketplace() {
  ...
  const sampleVendors = [
    { id: 'vendor1', name: 'Lagos Fresh Foods', location: 'Lagos', rating: 4.8, products: 25 },
    { id: 'vendor2', name: 'Abuja Spice Market', location: 'Abuja', rating: 4.6, products: 18 },
    { id: 'vendor3', name: 'Kano Grains Co.', location: 'Kano', rating: 4.9, products: 32 },
    { id: 'vendor4', name: 'Port Harcourt Seafood', location: 'Port Harcourt', rating: 4.7, products: 15 }
  ];
