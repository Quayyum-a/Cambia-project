      ...
      <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 text-sm text-center mb-4">
                Sign in with your Google account for a secure, password-free experience.
                Your information is protected with advanced privacy technology.
              </p>
              <ul className="text-blue-600 text-xs space-y-1">
                <li>✓ No password required</li>
                <li>✓ Privacy-preserving authentication</li>
                <li>✓ Automatic wallet setup</li>
        ...
        <div className="mt-8 bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-blue-700">Google Sign-In</h4>
