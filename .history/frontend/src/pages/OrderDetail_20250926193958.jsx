      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-gray-600 text-sm">{order.vendor.location}</p>
              </div>
              <div className="text-sm">
                <p className="text-gray-600">Contact: {order.vendor.email}</p>
              </div>
            </div>
          </div>

          {/* Customer Information (for vendors/logistics) */}
          {(user?.role === 'vendor' || user?.role === 'logistics') && (
            <div className="bg-white p-6 rounded-lg shadow">
              <h2 className="text-lg font-semibold mb-4">Customer Information</h2>
              <div className="space-y-3">
                <div>
                  <h3 className="font-semibold">{order.sender.name}</h3>
                  <p className="text-gray-600 text-sm">{order.sender.email}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              {user?.role === 'sender' && order.status === 'pending' && (
              ...
              {user?.role === 'logistics' && order.status === 'prepared' && (
                <button 
